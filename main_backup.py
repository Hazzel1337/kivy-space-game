...
class Ship2(Scatter):
    ...
    def __init__(self, **kwargs):
        ...
        #self.children[0].pos_hint = (None, None)
    ...
    def rotate(self):
        #kivy part
        self.apply_transform(Matrix().rotate(90, self.center[0], self.center[1], 0))
        # with self.children[0].canvas.before:
        #     Color(1, 0, 0, 1, mode='rgba')
            #PushMatrix()
            #Rotate(origin=self.children[0].center, angle=90)


        # with self.children[0].canvas.after:
        #     PopMatrix()
